...
export default async function HomePage({ searchParams }: { searchParams: Promise<CatalogSearchParams> }) {
  ...
  return <div className="min-h-screen">
    ...
    <main className="mx-auto max-w-6xl px-6 py-16 sm:px-12 sm:py-24">
      ...
      <form method="get" action="/" className="mt-10 flex flex-col gap-4 rounded-xl border border-navy/15 p-6 sm:flex-row sm:items-end">
      ...
      <section aria-labelledby="venues-heading" className="mt-16">
        <h2 id="venues-heading" className="mb-8 text-2xl font-semibold text-navy">{searchActive ? 'Venues matching your search' : 'Recently published venues'}</h2>
