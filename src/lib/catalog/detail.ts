...
export function toVenueDetail(venue: DetailVenueRow, spaces: DetailSpaceRow[], layouts: LayoutRow[], rates: RateRow[], now: Date): VenueDetailModel {
  ...
  return {
    id, slug, name, timezone, currency, description: venue.description,
